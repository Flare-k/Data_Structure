...
public:
    ...
    void SetPrimary(int inPri){primary = inPri;}
    ...
    void SetRecord(int inType, string inMusic, string inComposer,string inArtist, string inGenre, int inPri, int _inTime, int _numPlay){
        SetType(inType);
        SetMusic(inMusic);
        SetArtist(inArtist);
    ...
    void SetSingerRecord(string inMusic,string inArtist, int inPri, string _gender, int _age){
        SetMusic(inMusic);
        SetArtist(inArtist);
        SetPrimary(inPri);
        SetGender(_gender);
